...
describe("UserManagementService", () => {
  ...
  describe("hasPermission", () => {
    ...
    it("should check specific permissions for member", () => {
      ...
      // Act & Assert
      expect(userService.hasPermission(memberUser, "request.create")).toBe(
        true
      );
      expect(userService.hasPermission(memberUser, "request.delete")).toBe(
        false
      );
      expect(userService.hasPermission(memberUser, "user.view.self")).toBe(
        true
      );
    ...
    it("should check permissions for guest", () => {
      ...
      expect(userService.hasPermission(guestUser, "request.create")).toBe(
        false
      );
